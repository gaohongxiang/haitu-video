    ...
    >
      ...
      <button
        ...
        className={cn(
          ...
          pill && "min-h-9 w-auto rounded-[8px] border-[var(--border)] bg-[var(--field)] px-2.5 text-xs shadow-none hover:border-[color-mix(in_srgb,var(--accent)_45%,var(--border-strong))]",
