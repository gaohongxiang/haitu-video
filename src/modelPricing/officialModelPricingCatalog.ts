...
export const officialModelPricingCatalog = [
  ...
  },
  {
    ...
    output: "US$10.00",
    note: "OpenAI 官方文本模型价格快照；如果平台或用户启用该版本，运行时按真实模型名请求并按此快照估算成本。",
    status: "verified",
    sourceUrl: "https://developers.openai.com/api/docs/pricing",
    catalog: {
      providerId: "openai-compatible-text",
    ...
    inputPriceCnyPerMillion: 1.25 * usdToCnyForOfficialSnapshot,
    outputPriceCnyPerMillion: 10 * usdToCnyForOfficialSnapshot,
    cachedInputPriceCnyPerMillion: 0.125 * usdToCnyForOfficialSnapshot,
    fallbackPriceCnyPerCall: 0.08,
    settlement: usdTextSettlementRule({
      input: 1.25,
      output: 10,
      cachedInput: 0.125,
  ...
  },
  {
    ...
    inputPriceCnyPerMillion: 0.25 * usdToCnyForOfficialSnapshot,
    outputPriceCnyPerMillion: 2 * usdToCnyForOfficialSnapshot,
    cachedInputPriceCnyPerMillion: 0.025 * usdToCnyForOfficialSnapshot,
  ...
  },
  {
    ...
    inputPriceCnyPerMillion: 2 * usdToCnyForOfficialSnapshot,
    outputPriceCnyPerMillion: 8 * usdToCnyForOfficialSnapshot,
    cachedInputPriceCnyPerMillion: 0.5 * usdToCnyForOfficialSnapshot,
    fallbackPriceCnyPerCall: 0.08,
    settlement: usdTextSettlementRule({
      input: 2,
  ...
  },
  {
    ...
    inputPriceCnyPerMillion: 0.15 * usdToCnyForOfficialSnapshot,
    outputPriceCnyPerMillion: 0.6 * usdToCnyForOfficialSnapshot,
    cachedInputPriceCnyPerMillion: 0.075 * usdToCnyForOfficialSnapshot,
